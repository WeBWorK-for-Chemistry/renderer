...
<!-- JS Loads -->
<script src="/webwork/Problem/mathjax-config.js" defer></script>
...
<script src="/webwork/Problem/problem.js" defer></script>
<script src="/webwork/Problem/submithelper.js" defer></script>

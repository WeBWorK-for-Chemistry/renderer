...
function updateBrowser(formId, updateBackNav) {
    ...
    var displayRaw = new Promise((r) => r());
    var processData;
...
//        let problemseed = 1234;
        ...
        const source_params = {
            body: formDataRawFile,
            method: "post"
        };
        displayRaw = fetch(sourceurl, source_params).then(async (d) => {
            console.log("HEYER");
            console.log(value);
            console.log(d)
            ...
            console.log(text);
            cm.setValue(text);
            document.getElementById("currentEditPath").innerText = text;
